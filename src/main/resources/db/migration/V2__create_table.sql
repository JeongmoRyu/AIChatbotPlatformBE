...
VALUES(1, 'LLM', 'OPENAI', 'ch_gpt-4o', 1, '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', NULL, 'gpt-4o', NULL, '[{"label":"Top P","key":"top_p","range":{"from":"0.00","to":"1.00"},"mandatory":true,"value":"1"},{"label":"Temperature","key":"temp","range":{"from":"0.00","to":"2.00"},"mandatory":true,"value":"0.8"},{"label":"Presense penalty","key":"pres_p","range":{"from":"0.00","to":"2.00"},"mandatory":true,"value":"0.7"},{"label":"Frequency penalty","key":"freq_p","range":{"from":"0.00","to":"2.00"},"mandatory":true,"value":"0.5"},{"label":"Maximum tokens","key":"max_token","range":{"from":"","to":"4096"},"mandatory":true,"value":"2048"}]')
ON CONFLICT DO NOTHING;

INSERT INTO chathub.engine
(id, "type", vendor, "name", seq, apik, endpoint, model, "version", parameters)
VALUES(2, 'LLM', 'OPENAI', 'ch_gpt-4o-mini', 2, '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', NULL, 'gpt-4o-mini', NULL, '[{"label":"Top P","key":"top_p","range":{"from":"0.00","to":"1.00"},"mandatory":true,"value":"1"},{"label":"Temperature","key":"temp","range":{"from":"0.00","to":"2.00"},"mandatory":true,"value":"0.8"},{"label":"Presense penalty","key":"pres_p","range":{"from":"0.00","to":"2.00"},"mandatory":true,"value":"0.7"},{"label":"Frequency penalty","key":"freq_p","range":{"from":"0.00","to":"2.00"},"mandatory":true,"value":"0.5"},{"label":"Maximum tokens","key":"max_token","range":{"from":"","to":"4096"},"mandatory":true,"value":"2048"}]')
ON CONFLICT DO NOTHING;
INSERT INTO chathub.engine
(id, "type", vendor, "name", seq, apik, endpoint, model, "version", parameters)
VALUES(3, 'LLM', 'ONPREMISE', 'llama_3.1 70b inst', 3, '2a07daea-2d32-55ae-aea5-5ee26afd869b', '10.50.5.14:36000', 'albatross', 'albatross', '[{"label":"TopP","key":"top_p","range":{"from":"0.00","to":"1.00"},"mandatory":true,"value":"1"},{"label":"TopK","key":"top_k","range":{"from":"1","to":"100"},"mandatory":true,"value":"1"},{"label":"Temperature","key":"temp","range":{"from":"0.00","to":"2.00"},"mandatory":true,"value":"0.8"},{"label":"Presensepenalty","key":"pres_p","range":{"from":"0.00","to":"2.00"},"mandatory":true,"value":"0.7"},{"label":"Frequencypenalty","key":"freq_p","range":{"from":"0.00","to":"2.00"},"mandatory":true,"value":"0.5"},{"label":"Maximumtokens","key":"max_token","range":{"from":"","to":"4096"},"mandatory":true,"value":"2048"}]')
ON CONFLICT DO NOTHING;
INSERT INTO chathub.engine
(id, "type", vendor, "name", seq, apik, endpoint, model, "version", parameters)
VALUES(4, 'LLM', 'ONPREMISE', 'llama_3.1 8b inst', 4, '2a07daea-2d32-55ae-aea5-5ee26afd869b', '10.50.3.6:36000', 'hummingbird', 'hummingbird', '[{"label":"TopP","key":"top_p","range":{"from":"0.00","to":"1.00"},"mandatory":true,"value":"1"},{"label":"TopK","key":"top_k","range":{"from":"1","to":"100"},"mandatory":true,"value":"1"},{"label":"Temperature","key":"temp","range":{"from":"0.00","to":"2.00"},"mandatory":true,"value":"0.8"},{"label":"Presensepenalty","key":"pres_p","range":{"from":"0.00","to":"2.00"},"mandatory":true,"value":"0.7"},{"label":"Frequencypenalty","key":"freq_p","range":{"from":"0.00","to":"2.00"},"mandatory":true,"value":"0.5"},{"label":"Maximumtokens","key":"max_token","range":{"from":"","to":"4096"},"mandatory":true,"value":"2048"}]')
ON CONFLICT DO NOTHING;

INSERT INTO chathub.engine
(id, "type", vendor, "name", seq, apik, endpoint, model, "version", parameters)
VALUES(5, 'RAG', 'OPENAI', 'ch_text-embedding-ada-002', 1, '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', NULL, 'text-embedding-ada-002', NULL, '[{"label":"Top K","key":"top_k","range":{"from":"1","to":"10"},"mandatory":true,"value":"3"},{"label":"Maximum tokens","key":"max_token","range":{"from":"","to":"4096"},"mandatory":true,"value":"2048"}]')
ON CONFLICT DO NOTHING;
INSERT INTO chathub.engine
(id, "type", vendor, "name", seq, apik, endpoint, model, "version", parameters)
...
INSERT INTO chathub.engine
(id, "type", vendor, "name", seq, apik, endpoint, model, "version", parameters)
VALUES(8, 'FNCALL', 'OPENAI', 'ch_gpt-4o', 1, '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', NULL, 'gpt-4o', NULL, '[{"label":"Top P","key":"top_p","range":{"from":"0.00","to":"1.00"},"mandatory":true,"value":"1"},{"label":"Temperature","key":"temp","range":{"from":"0.00","to":"2.00"},"mandatory":true,"value":"0.8"},{"label":"Presense penalty","key":"pres_p","range":{"from":"0.00","to":"2.00"},"mandatory":true,"value":"0.7"},{"label":"Frequency penalty","key":"freq_p","range":{"from":"0.00","to":"2.00"},"mandatory":true,"value":"0.5"},{"label":"Maximum tokens","key":"max_token","range":{"from":"","to":"4096"},"mandatory":true,"value":"2048"}]')
ON CONFLICT DO NOTHING;
INSERT INTO chathub.engine
(id, "type", vendor, "name", seq, apik, endpoint, model, "version", parameters)
...
INSERT INTO chathub.engine
(id, "type", vendor, "name", seq, apik, endpoint, model, "version", parameters)
VALUES(10, 'FNCALL', 'ONPREMISE', 'maal_L3.1_70b', 3, '2a07daea-2d32-55ae-aea5-5ee26afd869b', '10.50.5.14:36000', 'albatross', 'albatross', '[  {    "label": "Top P",    "key": "top_p",    "range": {      "from": "0.00",      "to": "1.00"    },    "mandatory": true,    "value": "1"  },  {    "label": "Top K",    "key": "top_k",    "range": {      "from": "1",      "to": "100"    },    "mandatory": true,    "value": "1"  },  {    "label": "Temperature",    "key": "temp",    "range": {      "from": "0.00",      "to": "2.00"    },    "mandatory": true,    "value": "0.8"  },  {    "label": "Presense penalty",    "key": "pres_p",    "range": {      "from": "0.00",      "to": "2.00"    },    "mandatory": true,    "value": "0.7"  },  {    "label": "Frequency penalty",    "key": "freq_p",    "range": {      "from": "0.00",      "to": "2.00"    },    "mandatory": true,    "value": "0.5"  },  {    "label": "Maximum tokens",    "key": "max_token",    "range": {      "from": "",      "to": "4096"    },    "mandatory": true,    "value": "2048"  }]')
ON CONFLICT DO NOTHING;
INSERT INTO chathub.engine
(id, "type", vendor, "name", seq, apik, endpoint, model, "version", parameters)
VALUES(11, 'FNCALL', 'ONPREMISE', 'maal_L3.1_8b', 4, '2a07daea-2d32-55ae-aea5-5ee26afd869b', '10.50.3.6:36000', 'hummingbird', 'hummingbird', '[  {    "label": "Top P",    "key": "top_p",    "range": {      "from": "0.00",      "to": "1.00"    },    "mandatory": true,    "value": "1"  },  {    "label": "Top K",    "key": "top_k",    "range": {      "from": "1",      "to": "100"    },    "mandatory": true,    "value": "1"  },  {    "label": "Temperature",    "key": "temp",    "range": {      "from": "0.00",      "to": "2.00"    },    "mandatory": true,    "value": "0.8"  },  {    "label": "Presense penalty",    "key": "pres_p",    "range": {      "from": "0.00",      "to": "2.00"    },    "mandatory": true,    "value": "0.7"  },  {    "label": "Frequency penalty",    "key": "freq_p",    "range": {      "from": "0.00",      "to": "2.00"    },    "mandatory": true,    "value": "0.5"  },  {    "label": "Maximum tokens",    "key": "max_token",    "range": {      "from": "",      "to": "4096"    },    "mandatory": true,    "value": "2048"  }]')
ON CONFLICT DO NOTHING;
...
INSERT INTO chathub.engine
(id, "type", vendor, "name", seq, apik, endpoint, model, "version", parameters)
VALUES(13, 'RANKER', 'OPENAI', 'OpenAI/text-embedding-ada-002', 2, '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', NULL, 'text-embedding-ada-002', NULL, NULL)
ON CONFLICT DO NOTHING;
INSERT INTO chathub.engine
(id, "type", vendor, "name", seq, apik, endpoint, model, "version", parameters)
...
INSERT INTO chathub.engine
(id, "type", vendor, "name", seq, apik, endpoint, model, "version", parameters)
VALUES(16, 'RNK_EMBED', 'OPENAI', 'text-embedding-ada-002', 1, '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', NULL, 'text-embedding-ada-002', NULL, NULL)
ON CONFLICT DO NOTHING;
INSERT INTO chathub.engine
(id, "type", vendor, "name", seq, apik, endpoint, model, "version", parameters)
...
INSERT INTO chathub.engine
(id, "type", vendor, "name", seq, apik, endpoint, model, "version", parameters)
VALUES(19, 'RNK_LLM', 'OPENAI', 'gpt-4', 1, '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', NULL, 'gpt-4', NULL, NULL)
ON CONFLICT DO NOTHING;
