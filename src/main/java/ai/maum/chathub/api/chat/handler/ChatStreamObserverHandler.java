...
public class ChatStreamObserverHandler implements StreamObserver<ChatRequest> {
    ...
    private ChatScheduleTask chatScheduleTask;
    private ChatGrpcConnectionHandler connectionHandler;
...
//    public void setBaseStreamObserver(FluxSink<String> sink, ChatService chatService, ChatroomDetailVO chatroomDetail, String memberId, ChatbotVO chatbot, String question) {
    public void setBaseStreamObserver(ChatGrpcConnectionHandler connectionHandler, FluxSink<String> sink, ChatService chatService, ChatroomDetailVO chatroomDetail, ChatScheduleTask task) {
        setConnectionHandler(connectionHandler);
        setFluxSink(sink);
        setChatService(chatService);
        setChatroomDetail(chatroomDetail);
        setChatScheduleTask(task);
...
//    }
    ...
    public void setConnectionHandler(ChatGrpcConnectionHandler connectionHandler) {
...
//    public void setScheduler(ScheduledExecutorService scheduler) { this.scheduler = scheduler; }
    ...
    public ChatStreamObserverHandler(ManagedChannel channel, RagServiceGrpc.RagServiceStub ragServiceStub, String roomId, ChatbotVO chatbot) {
        ...
        this.baseStreamObserver = ragServiceStub.chatHandler(new StreamObserver<Rag.ChatResponse>() {
            ...
            public void onNext(Rag.ChatResponse chatResponse) {
                ...
                if (status != null && status.getCode() == Rag.Status.Code.STREAM_END) {
                    ...
                    chatService.setChatRoomDetail(chatbot, chatroomDetail, answer, seq);
