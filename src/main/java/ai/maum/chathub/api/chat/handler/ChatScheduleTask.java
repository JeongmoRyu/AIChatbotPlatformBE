...
@Getter
@Setter
public class ChatScheduleTask implements Runnable {
...
//    private final ScheduledFuture<?> scheduledFuture;
    ...
    public ChatScheduleTask(int maxExecutionCount, ChatScheduleManager chatScheduleManager, FluxSink<String> sink, String memberId, Long chatbotId, Long roomId, String question
                            ) {
