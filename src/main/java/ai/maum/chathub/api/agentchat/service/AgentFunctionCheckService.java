...
public class AgentFunctionCheckService {
...
//                .build();
            ...
            for (Map<String, Object> chatbotInfo : chatbotInfoMap) {
                ...
                switch (key) {
                    case ("normal_conversation"):
                        ...
                        agentProtoChatService.setLLMNode(chatbotInfo, apiKeyMap, llmEngines, nodeIndex, llmNodes, false);
                        break;
                    ...
                    case ("rag"):
                        ...
                        agentProtoChatService.setLLMNode(chatbotInfo, apiKeyMap, llmEngines,
    ...
    public CompletableFuture<String> callGrpcServer( rag_service.rag_module.RagServiceGrpc.RagServiceStub ragServiceStub,
                                                     Rag.ChatRequest requestWithConfig,
                                                     Rag.ChatRequest requestWithMessage) {
